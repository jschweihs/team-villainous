...
// ParamError implements the error interface
...
// of returning multiple errors. In this case, we are returning parameter errors.
// The API specifically can then just iterate through these errors, placing them
...
// ParamErrors defines a slice of ParamError
...
// ParamErrors implements the error interface
