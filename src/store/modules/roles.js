...
const actions = {
  addRole: ({commit}, name) => {
    axios.post('http://teamvillainous.com/api/v1/role/create.php', { name })
    .then(response => {
  ...
  getRoles: ({commit}) => {
    ...
    if(!this.a.state.roles) {
      return axios.get('http://teamvillainous.com/api/v1/role/get_all.php')
      .then(response => {
  ...
  updateRole: ({commit}, role) => {
    axios.put('http://teamvillainous.com/api/v1/role/update.php', role)
    .then(response => {
  ...
  removeRole: ({commit}, role_id) => {
    axios.post('http://teamvillainous.com/api/v1/role/delete.php', {id: role_id})
    .then(response => {
